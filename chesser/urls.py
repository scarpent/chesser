...
urlpatterns = [
    ...
    path("chapters/<str:color>/", views.home, name="color_chapters_view"),
    path("chapters/<str:color>/<int:chapter_id>/", views.home, name="chapter_view"),
    ...
    path("variations.json/", views.bulk_export_json, name="bulk_export_json"),
